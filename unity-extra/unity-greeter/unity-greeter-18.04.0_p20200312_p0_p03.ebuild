...
src_prepare() {
	...
	# 1. Use icon theme according to gsettings override per session
	# 2. Show nm-applet notification
	# 3. Fix keyboard layout to correspond with indicator-keyboard icon
